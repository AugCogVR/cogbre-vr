...
namespace PUL
{
    public class RadialMenuOption: MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            GameObject radialNeedlePrefab = ControllerManager.Instance.RadialNeedlePrefab;
            ...
            GameObject radialInfographicPrefab = ControllerManager.Instance.RadialInfographicPrefab;
