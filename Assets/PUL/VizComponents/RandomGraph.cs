...
namespace PUL
{
    ...
    public class RandomGraph : MonoBehaviour
    {
        ...
        [PublicAPI]
        public void AddNodeToGraph(Component component, int index)
        {
        ...
        {
            public SimpleCubeNode scn;   // TODO: This probably doesn't belong here OR should be a "node interface" for abstraction purposes
            public float Mass;
